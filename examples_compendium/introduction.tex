...
IPP4CPPS & x & & & & x & & x & &  & & x \\ \hline
\end{tabular}
\caption{Overview of INTO-CPS technologies used for pilot studies. Unmaintained models are marked with {\textcolor{lightRed}{\rule{1em}{1em}}}}
