...
The 3D animation FMU allows visualisation of the simulation. It is based on the Unity engine, and extends it by exporting the scenario and the 3D rendering as a FMU.
